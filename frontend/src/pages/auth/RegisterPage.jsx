          ...
          <form onSubmit={handleRegister} className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3.5 bg-gray-50 border border-gray-200 rounded-xl text-gray-900 placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all"
                required
              />
            </div>
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                >
                  ...
                  <div className={`font-semibold ${formData.role === 'Author' ? 'text-blue-700' : 'text-gray-700'}`}>Tác giả</div>
                  <div className="text-xs text-gray-500">Gửi bài báo</div>
                </button>
                <button
                  type="button"
                ...
                >
                  ...
                  <div className={`font-semibold ${formData.role === 'Reviewer' ? 'text-blue-700' : 'text-gray-700'}`}>Phản biện</div>
                  <div className="text-xs text-gray-500">Đánh giá bài báo</div>
                </button>
              </div>
            </div>
