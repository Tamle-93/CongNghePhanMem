...
<body style="font-family: Arial, sans-serif; line-height: 1.6;">
    <div style="max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #ddd; border-radius: 8px;">
        <h2 style="color: #7c3aed;">📝 Phân công phản biện</h2>
        <p>Kính gửi <strong>{reviewer_name}</strong>,</p>
        <p>Bạn được phân công phản biện bài báo:</p>
        <div style="background-color: #f3f4f6; padding: 15px; border-radius: 5px; margin: 20px 0;">
            <p><strong>Tiêu đề:</strong> {paper_title}</p>
            <p><strong>Hội nghị:</strong> {conference_name}</p>
            <p style="color: #dc2626;"><strong>⏰ Hạn phản biện:</strong> {deadline.strftime('%d/%m/%Y')}</p>
        </div>
        <p>Vui lòng đăng nhập vào hệ thống để xem chi tiết và hoàn thành phản biện.</p>
        <a href="http://localhost:5173" style="display: inline-block; padding: 10px 20px; background-color: #7c3aed; color: white; text-decoration: none; border-radius: 5px; margin: 10px 0;">
            Đăng nhập ngay
        </a>
        <hr style="margin: 20px 0; border: none; border-top: 1px solid #ddd;">
        <p style="color: #6b7280; font-size: 14px;">Trân trọng,<br>Ban tổ chức {conference_name}</p>
...
<body style="font-family: Arial, sans-serif; line-height: 1.6;">
    <div style="max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #ddd; border-radius: 8px;">
        ...
        {'<a href="http://localhost:5173" style="display: inline-block; padding: 10px 20px; background-color: #10b981; color: white; text-decoration: none; border-radius: 5px; margin: 10px 0;">Nộp bản hoàn chỉnh</a>' if decision == 'Accept' else ''}
        <hr style="margin: 20px 0; border: none; border-top: 1px solid #ddd;">
        <p style="color: #6b7280; font-size: 14px;">Trân trọng,<br>Ban tổ chức {conference_name}</p>
    </div>
</body>
